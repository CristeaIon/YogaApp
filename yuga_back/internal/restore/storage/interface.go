...
type RestorePasswordRepository interface {
	...
	ValidateCode(ctx context.Context, code model.ValidateCodeRequest) (model.ValidationData, error)
	UpdatePassword(ctx context.Context, email string, password string) (m.UserDAO, error)
}
